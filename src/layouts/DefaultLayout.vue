...
export default {
	...
	data: () => ({
		...
		exampleItems: [
			...
			{ title: 'GridSystem', icon: 'mdi-view-grid-outline', to: '/example/grid-system' },
			{
				title: 'GridListPage',
				icon: 'mdi-format-list-bulleted',
				to: '/example/grid-list-page',
			},
			{
				title: 'Break Points',
				icon: 'mdi-devices',
				to: '/example/break-points',
			},
			{ title: 'Typography', icon: 'mdi-format-text', to: '/example/typography' },
			{ title: 'SignIn', icon: 'mdi-login-variant', to: '/example/auth/sign-in' },
